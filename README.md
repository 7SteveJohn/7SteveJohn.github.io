...
2. **数据与界面完全解耦**：
   ...
   - 新增项目或写博客，仅需在对应文件追加数据，界面自动动态渲染。
3. **内置“新增项目助手”**：页面顶部自带可视化配置代码生成器，填好表单即可一键复制标准代码！
4. **全功能支持**：
...
### 方式 A：使用网页自带的“新增项目助手”（最快捷）
1. 在浏览器打开网站；
2. 点击右上角的 **“新增项目助手”** 按钮；
3. 填入你的项目名称、技术栈、简介、截图 URL、在线演示 Demo 链接与 GitHub 源码链接；
4. 点击 **“生成配置代码”**，点击 **“一键复制”**；
5. 打开 [`js/projects.js`](file:///d:/HTML/js/projects.js)，粘贴到 `PROJECTS_DATA` 数组的最前面，刷新页面即可看到新项目！

### 方式 B：手动编辑 `js/projects.js`
